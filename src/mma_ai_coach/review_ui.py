...
from mma_ai_coach import AnalysisResult
from mma_ai_coach.commentary import CommentarySegment
from mma_ai_coach.personas import CommentaryPersona
...
def launch_review(
    ...
    ui.run(port=port, title="MMA AI Coach — Fight Review", reload=False)
...
def _build_review_page(
    ...
    with ui.header().classes("items-center justify-between"):
        ui.label("MMA AI Coach — Fight Review").classes("text-xl font-bold")
