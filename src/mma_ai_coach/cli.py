"""CLI entry point for MMA AI Coach."""
...
app = typer.Typer(
    name="mma-coach",
    help="MMA AI Coach — Analyze martial arts videos with AI.",
...
@app.callback()
def main() -> None:
    """MMA AI Coach — Analyze martial arts videos with AI."""
...
def analyze(
    ...
    from mma_ai_coach.pipeline import MIN_ANALYSIS_DURATION
    ...
    console.print(f"[bold]MMA AI Coach[/] — Analyzing: [cyan]{video_path}[/]")
    console.print(f"  Interval: {interval}s | Batch size: {batch_size}")
    if duration:
        console.print(f"  Max duration: {duration}s")

    from mma_ai_coach.pipeline import run_pipeline
...
def review(
    ...
    import gc
    from mma_ai_coach.personas import get_persona, list_persona_ids
    ...
    console.print(f"[bold]MMA AI Coach[/] — Fight Review")
    ...
    from mma_ai_coach.pipeline import load_analysis
    ...
    from mma_ai_coach.renderer import render_annotated_video
    ...
    from mma_ai_coach.summarizer import load_text_model
    from mma_ai_coach.commentary import generate_commentary
    ...
    from mma_ai_coach.tts import load_tts_model, synthesize_continuous
    ...
    from mma_ai_coach.review_ui import launch_review
    launch_review(
