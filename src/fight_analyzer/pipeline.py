...
def run_pipeline(
    ...
    from fight_analyzer.analyzer import load_vision_model, analyze_frame
    from fight_analyzer.spatial import (
        compute_control,
        compute_proximity,
        compute_movement_vectors,
        detect_impact,
    )
    from fight_analyzer.extractor import extract_frames
